      ...
      Container(
          ...
          child: Column(children: [
            ...
            Expanded(child:
              ...
              _buildIconButton(
                  int position, String label, IconData icon, Widget container) {
                ...
                return Column(children: [
                  IconButton(
                      ...
                      onPressed: () => context
                          .read<AdminCubit>()
                          .setSideBarItemAndContainer(position, container),
                      icon: Icon(icon)),
                  Text(label,
                      style: TextStyle(
                          fontSize: 10,
              ...
              return ListView(children: [
                _buildIconButton(
                    0, 'Home', Icons.home_rounded, const Welcome()),
                _buildIconButton(1, 'Categorias', Icons.category_rounded,
                    const CategoryAdminScreen()),
                _buildIconButton(2, 'Productos', Icons.shopping_bag_rounded,
                    const ProductAdminScreen()),
                _buildIconButton(3, 'Usuarios', Icons.account_circle_rounded,
            ...
            Column(children: [
              ...
              const Text('Cerrar sesion', style: TextStyle(fontSize: 10)),
              const SizedBox(height: 10)
            ]),
            const SizedBox(height: 10)
          ])),
